  ...
  return (
    <>
      <Container className="mt-4">
        ...
        <div>
          <h1>
            <Badge bg='light' text="black" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            {minutes >= 10 ? minutes : `0${minutes}`}:
            {seconds >= 10 ? seconds : `0${seconds}`}
            </Badge>
          </h1>
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom:'5vh'}}>
